...
#define FILE_HEADER_SIGNATURE_RLMC		'RLMC' // 0x524c4d43
#define FILE_HEADER_SIGNATURE_RLPA		'RLPA' // 0x524c5041

#define FILE_HEADER_SIGNATURE_RLTP		'RLTP' // 0x524c5450
#define FILE_HEADER_SIGNATURE_RLTS		'RLTS' // 0x524c5453

#define FILE_HEADER_SIGNATURE_RLVC		'RLVC' // 0x524c5643
#define FILE_HEADER_SIGNATURE_RLVI		'RLVI' // 0x524c5649
